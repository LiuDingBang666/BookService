...
<div class="container ">
    <div class="row" style="margin: 10px;">
        <a href="<%=basePath%>user/goIndex">首页</a>- 订单信息
    </div>
    <div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input disabled value="${orderInfo.receiverAddress}" name="receiverAddress" class="form-control" id="address"
                       rows="3" required
                       placeholder="收货地址..."/>
            </div>
        </div>
    ...
    <div class="row col-md-1 pull-right ">
        <button class="btn btn-danger" data-toggle="modal" onclick="payment(value) " value="${orderInfo.orderid}">支付
        </button>
    </div>
    </c:if>
    ...
    <script>
        function payment(value) {
            ...
            $.post("<%=basePath%>user/orderPayment?id=" + value, function (data) {
                if (data == "OK") {
                    window.location.href = "<%=basePath%>user/goInfo";
                } else {
                    alert("订单支付失败！请重试")
                }
